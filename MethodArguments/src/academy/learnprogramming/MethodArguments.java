...
public class MethodArguments {
   ...
   int plusMinus(int a, int b, int c) { // 3 arguments (triadic) -> should be avoided if possible
       return a + b -c;
   }

   double average (double a, double b, double c, double d) {  // 4 arguments (polyadic) -> should be avoided if possible
       return (a+b+c+d)/4.0;
   }
