...
public class CommonArrayProblems {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i<= numbers.length-1; i++) { // must have "numbers.length -1" if using <= instead of <
            System.out.println(i + " - " + numbers[i]);
        }
      ...
      //  numbers.length = 10; // does not compile -> can't set length of array, only on initialization
    }
}
